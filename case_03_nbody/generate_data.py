...
import numpy as np
import argparse
from simulate_sys.system import System
...
parser.add_argument('--length_test', type=int, default=10000, # we need longer trajectories to test
...
# python -u generate_data.py --num-train 5000 --seed 43 --n_isolated 3 --n_stick 2 --n_hinge 1  --n_workers 50 --path data_321
