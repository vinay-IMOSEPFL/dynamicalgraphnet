import numpy as np
from simulate_sys.physical_objects import Isolated, Stick, Hinge
...
class System:
    ...
    def compute_F(self, X, V):
        ...
        with np.errstate(divide='ignore'):
            ...
            dist2[diag_idx, diag_idx] = np.inf

            # half step leapfrog
            l2_dist_power3 = np.power(dist2, 1.5)

            # size of forces up to a 1/|r| factor
            # since I later multiply by an unnormalized r vector
            forces_size = self.interaction_strength * self.edges / l2_dist_power3
            forces_size[diag_idx, diag_idx] = 0.0
