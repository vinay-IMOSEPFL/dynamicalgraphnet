...
from utils.utils_implicit import evaluate
...
class Trainer:
    ...
    def train(self, train_graph):
        ...
        loss = (F.mse_loss(pred_node_disp_,actual_node_disp_) + F.mse_loss(pred_node_dvel_,actual_node_dvel_) + F.mse_loss(residual, actual_residual))
